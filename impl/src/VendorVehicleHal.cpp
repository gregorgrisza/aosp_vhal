...
namespace impl {
  ...
  VendorVehicleHal::VendorVehicleHal(vhal_v2_0::VehiclePropertyStore* propStore, VehicleHalClient* client)
  : mPropStore(propStore)
  , mVehicleClient(client)
  , mRecurrentTimer(
    std::bind(&VendorVehicleHal::onContinuousPropertyTimer, this, std::placeholders::_1))
{
  regPropsInPropStore();

  mVehicleClient->registerPropertyValueCallback(std::bind(
      &VendorVehicleHal::onPropertyValue, this, std::placeholders::_1, std::placeholders::_2));
}

void VendorVehicleHal::onCreate()
{
  initPropsInPropStore();
}

std::vector<vhal_v2_0::VehiclePropConfig> VendorVehicleHal::listProperties()
{
  return mPropStore->getAllConfigs();
}

VendorVehicleHal::VehiclePropValuePtr VendorVehicleHal::get(
...
vhal_v2_0::StatusCode VendorVehicleHal::set(const vhal_v2_0::VehiclePropValue& propValue)
{
...
vhal_v2_0::StatusCode VendorVehicleHal::subscribe(int32_t property, float sampleRate)
{
...
vhal_v2_0::StatusCode VendorVehicleHal::unsubscribe(int32_t property)
{
  if (isContinuousProperty(property))
  {
...
void VendorVehicleHal::onPropertyValue(const vhal_v2_0::VehiclePropValue& value, bool updateStatus)
{
...
void VendorVehicleHal::regPropsInPropStore()
{
  for (const auto& it : kVehicleProperties) mPropStore->registerProperty(it.config);
}

void VendorVehicleHal::initPropsInPropStore()
{
...
void VendorVehicleHal::onContinuousPropertyTimer(const std::vector<int32_t>& properties)
{
...
bool VendorVehicleHal::isContinuousProperty(int32_t propId) const
{
